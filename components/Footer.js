          ...
          <div className="footer-col-wrapper">
            <div className="footer-col footer-col-1">
              {this.state && this.state.isClicked ?
                <span>{(this.state && this.state.emailAddress) || 'm..'}@gmail.com</span>
                :
                <span><a href="#" onClick={(e) => this.onEmailAddressClick(e)} title="Reveal this e-mail address">m..</a>@gmail.com</span>
              }
